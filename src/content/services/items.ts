...
export const serviceItems: ServiceItem[] = [
  {
    ...
    excerpt:
      "Studio-quality listing images designed to meet platform specs and maximise conversions for Indian e-commerce sellers.",
    content: `
      ...
      <p>Traditional product photography in India costs ₹8,000–₹40,000 per SKU. You need a studio, photographer, props, and days of coordination. For sellers with 10+ SKUs, that's ₹80,000–₹4,00,000 before a single sale.</p>
      <p>CGI-based product visualization delivers the same (often better) output at 80% less cost. Benefits include: perfect lighting every time, unlimited angles without reshoots, easy seasonal updates, and no product shipping required. This is how modern Amazon and Flipkart brands scale their catalogs efficiently.</p>

      <h2>Platform Compliance — Amazon & Flipkart Specs We Follow</h2>
      <p><strong>Amazon India:</strong> Pure white background (RGB 255,255,255), product fills 85%+ of frame, minimum 1500×1500px, no text/watermarks on hero image, JPEG/PNG/TIFF format.</p>
  ...
  },
  {
    ...
    description:
      "Amazon A+ Content design for Indian brand-registered sellers — custom modules, Brand Story, comparison charts, 99% approval rate, delivered in 5 days.",
    excerpt:
    ...
    content: `
      ...
      <p>With 12 lakh+ sellers on Amazon India, A+ Content is what separates "real brands" from random resellers. When buyers scroll past your bullet points, they see either a plain text block from 2015 — or a magazine-quality visual experience. Which seller looks trustworthy? Which one gets the sale?</p>
      <p>A+ Content is completely free for Brand Registered sellers. Every day without it is money left on the table.</p>

      <h2>Our 5-Module Strategy That Converts</h2>
      <p>After designing A+ Content for 200+ Indian brands, we've identified the exact module structure that maximizes conversion:</p>
      ...
      <p>Amazon's A+ Content rejection rate for first-time submissions is 30–40%. Common triggers include: pricing claims ("50% off", "cheapest"), competitor brand mentions, contact information, unsubstantiated health claims, and images under 970px width.</p>
      <p>Our approval rate is 99% on first submission. We've submitted thousands of A+ modules across every category and know exactly what Amazon's review team looks for.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p><strong>2. Increases basket size:</strong> When buyers browse your full catalog in one place, they discover products they didn't search for. Amazon data shows Brand Store visitors are 60% more likely to buy multiple products in one session.</p>
      ...
      <p><strong>Day 5–8:</strong> Full visual design with custom banners, lifestyle imagery, and branded components. Mobile-first design (80%+ of Amazon India traffic is mobile).</p>
      ...
      <p>Sponsored Brands ads (the banner ads at the top of Amazon search results) can link directly to your Brand Store. This is the highest-converting ad format on Amazon India because:</p>
      <p>The buyer clicks your ad → lands on YOUR store (no competitor distractions) → browses your full catalog → adds multiple products to cart. Average order value from Brand Store traffic is 35% higher than regular product page traffic.</p>

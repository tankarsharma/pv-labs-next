...
const caseStudies = [
  {
    ...
    solution: "We rebuilt the entire visual identity for Flipkart â€” studio-quality hero image, white background compliant, product fills 85% of frame, shadow work, ingredient callout infographics, and lifestyle imagery. Every image designed to stop the scroll and answer a buyer objection before they could ask it.",
    results: [
  ...
  },
  {
    ...
    duration: "5 Days",
    heroImage: nipura,
    problem: "Nipura Jewellery was live on Myntra but had a default seller page â€” no RPD modules, no brand banner, no material callouts, no size reference. In a category full of premium-looking jewellery brands, they were completely invisible. Buyers couldn't see the craftsmanship. Price looked unjustified.",
    solution: "We designed a complete Myntra RPD â€” brand story banner, material callout modules showing 92.5 sterling silver hallmark, styling guide with Indian skin tone reference, size and weight reference for every earring. Now the listing sells the craftsmanship before the buyer even reads a word.",
    results: [
    ...
    beforeAfter: { before: "Default Myntra page, no RPD, no brand identity, no modules", after: "Complete RPD â€” material callouts, styling guide, size reference live" },
  },
  {
    ...
    duration: "6 Days",
    heroImage: attar,
    problem: "Attar Ayurveda had a quality bhringraj powder product but their Amazon listing was plain text only â€” no banners, no visuals, no brand story, no ingredient callouts. Competitors with A+ content were outranking them despite an inferior product. Buyers had no reason to trust an Ayurvedic health product with zero visual credibility.",
    solution: "We built a complete A+ module from scratch â€” Ayurvedic brand story banner, ingredient sourcing story, usage guide visuals, Ayush certification highlight, and lifestyle imagery showing the product in daily routine. All within Amazon's EBC guidelines. Every module built to establish trust before the buyer scrolls to reviews.",
    results: [
    ...
    beforeAfter: { before: "Plain text description, no banners, no visuals, no brand story", after: "Full A+ module â€” ingredient sourcing, usage guide, certification highlights" },
  },
  {
    ...
    testimonial: { text: "We always struggled to show buyers why our product was worth trusting. PV Labs built visuals that do that automatically â€” without us saying a word.", author: "Only Essentials", role: "D2C Brand, Ayurvedic Gut Health" },
    beforeAfter: { before: "Generic images, no ingredient story, no trust badges, no brand identity", after: "Premium D2C visual set â€” ingredient callouts, lifestyle imagery, trust badges, Ayurvedic positioning clear" },
  },
  {
    id: "aakirti-ajio",
    ...
    duration: "7 Days",
    heroImage:Aakirti,
    problem: "Aakirti had 40+ ethnic suit SKUs ready to list on Ajio but only had basic front-facing images â€” no flat lays, no detail shots, no fabric close-ups, no lifestyle context. Ajio's catalog standards require multiple angles and lifestyle imagery â€” their listings kept getting rejected. Beautiful suits, invisible on the platform.",
    solution: "We created a complete catalog set for all 40+ SKUs â€” flat lay, styled shot, detail shot, and fabric texture close-up per SKU. Standardized visual language across the entire range so the brand looked cohesive on Ajio's grid. Every image built to Ajio's exact catalog specifications.",
    results: [
    ...
    beforeAfter: { before: "Basic front-facing images, listing rejections, no catalog standard", after: "Complete catalog set â€” flat lay, detail shot, size guide, Ajio compliant" },
  },
  {
    id: "aldo-sandal-d2c",
    ...
    duration: "5 Days",
    heroImage: aldo,
    problem: "ALDO had a quality sandal product selling on marketplaces but zero D2C presence â€” no website, no brand identity online, no direct customer relationship. Their product visuals were inconsistent â€” different angles, different lighting, different backgrounds across platforms. No visual system. No brand story. Buyers couldn't tell if this was a premium brand or a generic reseller.",
    solution: "We created a complete D2C visual set for ALDO's brand website â€” premium product photography style visuals, multiple angles per SKU, lifestyle context shots showing sandals in real environments, clean white background hero images, and detail shots highlighting craftsmanship. Every visual consistent across the entire product range â€” one unified brand language.",
    results: [
      { metric: "Premium", label: "D2C Brand Feel Achieved" },
      { metric: "5 Days", label: "Full Visual Set Live" },
      { metric: "Zero", label: "Studio Shoot Required" },
    ...
    beforeAfter: { before: "Inconsistent marketplace images, no brand identity, no visual system", after: "Premium D2C visual set â€” multiple angles, lifestyle context, consistent brand language" },
  },
  {
    ...
    client: "Ashoka",
    category: "Packaging Â· Flipkart Â· Brand Website",
    duration: "6 Days",
    heroImage: ashoka,
    problem: "Ashoka had a quality dry fruits product but their packaging looked homemade â€” basic label design, no brand color system, no visual hierarchy, no premium positioning. On Flipkart shelves dominated by established dry fruit brands, they were completely invisible. Same product on their website had completely different images â€” zero consistency across platforms. Buyers couldn't justify the price because the packaging didn't match the quality.",
    solution: "We redesigned the complete packaging system for Ashoka â€” new label design with premium color system, clear visual hierarchy, product window highlighting the dry fruits inside, FSSAI and quality certification badges prominently placed. Then extended the same visual language to Flipkart listing images and D2C website product visuals â€” so every touchpoint told the same premium, consistent brand story.",
    results: [
    ...
    testimonial: { text: "Our product quality was always there. PV Labs made our packaging finally show it. We look like a premium brand now â€” not just another dry fruits seller.", author: "Ashoka", role: "Flipkart Seller, Dry Fruits" },
    beforeAfter: { before: "Basic label, no brand system, inconsistent images across platforms", after: "Premium packaging design â€” unified visual language on Flipkart + website both" },
  },
  {
    id: "highek-blazer",
    title: "Great blazer. Zero brand identity. Ads spending money with nothing to show. Here's how we turned it around.",
    client: "HighEk",
    category: "Branding Â· Ads Creative Â· Amazon",
    duration: "7 Days",
    heroImage: blazer,
    problem: "HighEk had a premium blazer product on Amazon but two critical problems â€” first, zero brand identity: no consistent visual language, no brand story, no A+ content, nothing to differentiate from 100 other blazer sellers. Second, their Meta ad creatives were generic product shots with no conversion focus â€” high spend, low returns. Money going out, sales not coming in. Both problems had the same root cause: no visual strategy.",
    solution: "We tackled both simultaneously. First, built a complete A+ content module for Amazon â€” brand story banner, fabric detail highlights, size guide, styling imagery, care instructions. Then designed high-converting Meta ad creatives â€” multiple formats, conversion-focused layouts, brand consistent design. Same visual language across Amazon listing and Meta ads â€” so every touchpoint reinforced the same premium brand message.",
    results: [
    ...
    beforeAfter: { before: "Generic listing, no brand identity, low-converting ad creatives", after: "Complete A+ content + high-converting Meta ad creatives â€” same brand language across all touchpoints" },
  },
];
